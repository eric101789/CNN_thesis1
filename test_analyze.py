...
df2 = pd.read_csv('result/testing/1D_test/test_LSTM_results_epoch800.csv')
...
plt.savefig('result/testing/1D_test/test_LSTM_probability_epoch800.png')
plt.show()
...
plt.ylabel('Probability')
plt.title('Prediction Probability')
plt.savefig('result/testing/1D_test/test_LSTM_probability_plot_epoch800.png')
plt.show()
