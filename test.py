...
model1 = tf.keras.models.load_model("model/1D_test/train_model_LSTM_epoch700")
model1.summary()
...
results_df.to_csv('result/testing/1D_test/test_LSTM_results_epoch700.csv', index=False)
